...
# inside your script (e.g. at the top of launch.py)
import os, torch
# local_rank = int(os.environ.get("LOCAL_RANK", -1))
# print(f"Process {local_rank} → GPU {torch.cuda.current_device()}")
...
def parse_args():
    ...
    parser.add_argument("--exclude", default="", type=str,
                        help="Comma-separated nodes to exclude in SLURM")
    ...
    parser.add_argument("--config", default="configs/default_cot.yaml", type=str,
